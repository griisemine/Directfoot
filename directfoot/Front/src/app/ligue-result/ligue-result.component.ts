...
export class LigueResultComponent implements OnInit {
   ...
   */
   ...
   //   this.http.get(this.ROOT_URL + params ,{ headers , responseType: 'text' } ).subscribe( data =>  this.dataParser( JSON.parse(data) )  );
              
      this.http.get('https://samymahi.eu/ligue.json' ,{  responseType: 'text' } ).subscribe( data =>  this.dataParser( JSON.parse(data) )  );
    }
